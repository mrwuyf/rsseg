...
from geoseg.models.SLCNet import SLCNet
...
weights_name = "slcnet-r50-512-crop-ms-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "slcnet-r50-512-crop-ms-e100"
...
#  define the network
net = SLCNet(num_classes=num_classes)
